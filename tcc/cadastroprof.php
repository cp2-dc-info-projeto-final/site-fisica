	...
	<div class="Cadastro">
		...
		<?php } ?>
			...
			<button type="submit" class="btn2">Cadastrar</button><br>
				...
				<?php if($usuario !=null  ||  $usuario['matricula'] != null){ ?>
      		<a href="paginInc.php" > <button type="button" class="btn3" onclick="closeForm()">Fechar</button></a> <?php } ?> 
			 <?php else { ?> <a href="login.php" ><?php } ?><button type="button" class="btn3" onclick="closeForm()">Fechar</button></a> <?php } ?>
