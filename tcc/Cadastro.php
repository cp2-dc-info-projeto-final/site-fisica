...
<body> 
	<div class="Cadastro">
		<form name="signup" method="post" action="cadastrando.php">
			...
			<input type="email" minlength="10" maxlength="30" placeholder="Digite seu email" name="email">
			
			<label ><b class="textcol" >Senha</b></label>
			<input type="password" minlength="7" maxlength="15" placeholder="Digite sua senha" name="senha">
			
			<label ><b class="textcol" >Confirma senha</b></label>
			<input type="password" minlength="7	" maxlength="15" placeholder="Digite novamente sua senha" name="confirmasenha">
			<br>
