...
<body> 
	<div class="Cadastro">
		<form method="post" action="CADASTROUSUARIO.php">
			...
			<input type="text" required minlength="6" maxlength="16" placeholder="Digite seu usuário">
			
			<label for="email"><b class="textcol">Email</b></label>
			<input type="email" required minlength="10" maxlength="30" placeholder="Digite seu email">
			
			<label for="senha"><b class="textcol">Senha</b></label>
			<input type="password" required minlength="7" maxlength="15" placeholder="Digite sua senha">
			
			<label for="confirmaSenha"><b class="textcol">Confirma senha</b></label>
			<input type="password" required minlength="7	" maxlength="15" placeholder="Digite novamente sua senha">
			<br>
